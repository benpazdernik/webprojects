				...
				<td class="tckt-slctr-tkt-details-td" colspan="4" style="padding: 0;border-top:none;">
					<div id="tckt-slctr-tkt-details-<?php echo $EVT_ID . '-' . $TKT_ID; ?>-dv" class="tckt-slctr-tkt-details-dv" style="display: none;">
						...
						<section class="tckt-slctr-tkt-sale-dates-sctn">
							...
							<span class="ticket-details-label-spn drk-grey-text"><?php _e( 'Goes On Sale:', 'event_espresso' ); ?></span><span class="dashicons dashicons-calendar"></span><?php echo date_i18n( 'l, j. F Y', strtotime( $ticket->start_date() )) . ' &nbsp; '; ?><span class="dashicons dashicons-clock"></span><?php echo date_i18n( 'g:i', strtotime( $ticket->start_date() )) ; ?><br/>
							<span class="ticket-details-label-spn drk-grey-text"><?php _e( 'Sales End:', 'event_espresso' ); ?></span><span class="dashicons dashicons-calendar"></span><?php echo date_i18n( 'l, j. F Y', strtotime( $ticket->end_date() )) . ' &nbsp; '; ?><span class="dashicons dashicons-clock"></span><?php echo date_i18n( 'g:i', strtotime( $ticket->end_date() )) ; ?><br/>
						</section>
						<br/>
								...
								<table class="tckt-slctr-tkt-details-tbl">
									...
									<tr>
										<td class="small-text">
											...
											<?php echo $datetime->date_range( 'l, j. F Y', __( ' to  ', 'event_espresso' )); ?>										
										</td>
